...
if ($_REQUEST['Submit'] == 'Submit') {
    ...
    // if (testRepeat('category', 'category_name', $_REQUEST['category_name'], 'tbid', $_REQUEST['htid'])) {
        ...
        if(($_FILES["banner_image"]["name"] != '') || ($_FILES["slider_image"]["name"] != '') || ($_FILES["document_proof"]["name"] != '')){
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Admin | Modify News & Events</title>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <div class="page-title-left">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active font-size-18">/ Modify News & Events</li>
                                        </ol>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 mb-2">
                                                    ...
                                                    <div class="input-group mb-2" id="datepicker2">
                                                        <input type="text" class="form-control" name="date" id="date" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true" value="<?php echo ($date == '') ? $UpdateRec['date'] : $date; ?>">
