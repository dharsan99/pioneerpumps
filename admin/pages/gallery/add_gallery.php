...
if ($_REQUEST['Submit'] == 'Submit') {
    ...
    // if (testRepeat('category', 'category_name', $_REQUEST['category_name'], 'tbid', $_REQUEST['htid'])) {
            ...
            if (in_array($imageFileType, $AllowImageType)) {
                if (!file_exists($target_file)) {
                    if (move_uploaded_file($_FILES["banner_image"]["tmp_name"], $target_file)) {
                        ...
                        echo 'Your gallery image is not upload .';
                    }
                } else {
                    $error = 0;
                }
        ...
        if ((isset($_REQUEST['htid']) && ($_REQUEST['htid'] != ''))) {
            $message = updateRecords('gallery', $insertvalue, 'tbid', $_REQUEST['htid'], '0');
            header("location:" . AdminUrl . 'gallery/list_gallery.htm');
            exit;
        }
        else {
            $message = insertRecords('gallery', $insertvalue, '0');
            header("location:" . AdminUrl . 'gallery/list_gallery.htm');
            exit;
        }
    // }else {
...
if ((isset($_REQUEST['htid']) && ($_REQUEST['htid'] != ''))) {
    $UpdateRec = getRecords('gallery', 'tbid', $_REQUEST['htid']);
}
?>
<!doctype html>
<html lang="en">
    ...
    <head>
        ...
        <meta content="Dhya x Pioneer Dashboard" />
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <div class="page-title-left">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item font-size-18">Gallery Images</li>
                                            <li class="breadcrumb-item active font-size-18">/ Add Gallery images</li>
                                        </ol>
                                    </div>

                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-primary waves-effect waves-light">
                                            <a href="<?php echo AdminUrl . 'gallery/list_gallery.htm'; ?>" style="color: #fff;"><i class="bx bx-list-ul font-size-16 align-middle me-2"></i> List Gallery Images</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form class="custom-validation" action="#" enctype="multipart/form-data" autocomplete="off" method="POST">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 mb-2">
                                                    <label for="formFile" class="form-label">Gallery Image<span class="messages" style="color: red;"> * Size(Height: 150px, Width:150px)</span></label>
                                                ...
                                                <div class="col-sm-4 mb-2">
                                                    <div class="thumbnail">
                                                        <div class="thumb">
                                                            <a href="<?php echo SiteUrl . "images/gallery/". $UpdateRec['banner_image']; ?>"
                                                                data-lightbox="1" data-title="Store Logo">
                                                                <img style="min-width: 150px;max-width: 150px;" src="<?php echo SiteUrl . "images/gallery/" . $UpdateRec['banner_image']; ?>">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex flex-wrap gap-2 float-end">
                                                ...
                                                <button type="reset" class="btn btn-secondary waves-effect"><a href="<?php echo AdminUrl . 'gallery/list_gallery.htm'; ?>" style="color: #fff;">Cancel</a></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
