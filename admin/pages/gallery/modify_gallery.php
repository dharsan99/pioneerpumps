                ...
                if (in_array($imageFileType, $AllowImageType)) {
                    if (!file_exists($target_file)) {
                        if (move_uploaded_file($_FILES["banner_image"]["tmp_name"], $target_file)) {
                            ...
                            echo 'Your gallery image is not uploaded .';
                        }
                    } else {
                        $error = 0;
                    }
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Admin | Modify gallery</title>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <div class="page-title-left">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active font-size-18">/ Modify Gallery Images</li>
                                        </ol>
                                    </div>

                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-primary waves-effect waves-light">
                                            <a href="<?php echo AdminUrl . 'gallery/list_gallery.htm'; ?>" style="color: #fff;"><i class="bx bx-list-ul font-size-16 align-middle me-2"></i> List Gallery</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
