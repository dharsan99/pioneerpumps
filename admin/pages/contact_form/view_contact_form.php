...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Admin | View Contact Form</title>
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <div class="page-title-left">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active font-size-18">/ View Contact Form</li>
                                        </ol>
                                    </div>

                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-primary waves-effect waves-light">
                                            <a href="<?php echo AdminUrl . 'contact_form/list_contact_form.htm'; ?>" style="color: #fff;"><i class="bx bx-list-ul font-size-16 align-middle me-2"></i> List Contact Form</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table>
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    <td>Address</td>
                                                    <td class="colon">:</td>
                                                    <td><?php echo $ContactFormRec['address']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Message</td>
                                                    <td class="colon">:</td>
                                                    <td><?php echo $ContactFormRec['message']; ?></td>
                                                </tr>
                                            </thead>
                                            <?php
                                                }
